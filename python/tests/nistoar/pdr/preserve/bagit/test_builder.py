...
class TestBuilder2(test.TestCase):
    ...
    def setUp(self):
        ...
        if len(self.bag.plog.handlers) > 0:
            print("warning: setUp found stray handlers attached:"+
    ...
    def tearDown(self):
        ...
        self.bag = None
        self.tf.clean()
        if plog and len(plog.handlers) > 0:
            print("ERROR: tearDown found stray handlers attached:"+
                  ("\n".join([str(h) for h in plog.handlers])))
#            self.bag.disconnect_logfile()
    ...
    def test_update_md(self):
        ...
        self.assertEqual(md, {"foo": "bar", "hank": "herb"})

        self.bag._update_md(md, {"hank": "aaron"})
        self.assertEqual(md, {"foo": "bar", "hank": "aaron"})

        self.bag._update_md(md, {"hank": ["herb", "aaron"]})
        self.assertEqual(md, {"foo": "bar", "hank": ["herb", "aaron"]})
    ...
    def test_update_annotations_for_nonfile(self):
        ...
        self.assertEqual(len(md.get('components',[])), 1)
        md = md['components'][-1]
    ...
    def test_determine_file_comp_type(self):
        ...
        self.assertEqual(self.bag._determine_file_comp_type("goob.txt.sha256"),
                          "ChecksumFile")
        self.assertEqual(self.bag._determine_file_comp_type("goob.txt.sha512"),
                          "ChecksumFile")
        self.assertEqual(self.bag._determine_file_comp_type("goob.txt.md5"),
                          "ChecksumFile")
        self.assertEqual(self.bag._determine_file_comp_type("goob.txt.sha"),
                          "DataFile")
...
#        self.assertEqual(data['@id'], "ark:/88434/mds00hw91v")
        ...
        self.assertEqual(data['@id'], "cmps/trial3/trial3a.json")
    ...
    def test_write_baginfo_data(self):
        ...
        data['Description'] = "The data is at \u03bb = 20cm."
    ...
    def test_ensure_baginfo(self):
        ...
        self.assertEqual(oxum[0], 12212)  # this will change if logging changes
