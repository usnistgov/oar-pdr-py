...
class TestCLI(test.TestCase):
    ...
    def test_Failure(self):
        ex = cli.Failure("oops!")
        self.assertEqual(str(ex), "oops!")
        self.assertEqual(ex.exitcode, 1)

        ex = cli.Failure("boo!", 3, RuntimeError("oops!"))
        self.assertEqual(str(ex), "boo!")
        self.assertEqual(ex.exitcode, 3)
        self.assertEqual(str(ex.cause), "oops!")
    ...
    def test_read_config(self):
        ...
        self.assertEqual(cfg['archive_targets'], ['operators'])
