...
class TestTargetManager(test.TestCase):
    ...
    def test_aa_register_channel_class(self):
        ...
        self.assertFalse(mgr.has_channel_class("fakefemail"))
        ...
        self.assertTrue(mgr._channelcls["fakeremail"] is fm)
        ...
        self.assertTrue(mgr._channelcls["fakieremail"] is fmer)
    ...
    def test_define_channel(self):
        ...
        self.assertIn('arch', mgr.channel_names)
        self.assertIn('archive', mgr.channel_names)
    ...
    def test_define_target(self):
        ...
        self.assertIn('gary', mgr.targets)
        self.assertIn('cooper', mgr.targets)
        self.assertIn('gary', mgr)
...
class TestNotificationService(test.TestCase):
    ...
    def test_ctor(self):
        ...
        self.assertIn('fakeemail', self.svc.channels)
        self.assertIn('archive', self.svc.channels)
        self.assertIn('me', self.svc.targets)
        self.assertIn('operators', self.svc.targets)
