...
class TestEmailTarget(test.TestCase):
    ...
    def test_format_body(self):
        ...
        # arbitrary properties appear at the end of message in undetermined order
        self.assertGreater(body.index("color: grey"), 11)
        self.assertGreater(body.index("platform: unittest"), 11)
        self.assertGreater(body.index("excitation: False"), 11)
