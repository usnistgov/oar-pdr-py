...
These modules include:
  ...
  * :py:mod:`rmm` -- a module for loading metadata and support files into the PDR's metadata system
  * ``edi`` -- a module for delivering POD records derived from AIP NERDm data to the NIST EDI
  * :py:mod:`dc`  -- a module for delivering DataCite records to DataCite
...
from .dc import DOIMintingClient, DOIClientException
