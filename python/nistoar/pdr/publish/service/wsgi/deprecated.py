"""
This module provides some depecated rest app orchestrations that have been superseded.  

This module includes the original implementations of the pdp0 WSGIApp that only supports the 
pdp0 convention as well as its accompanying :py:class:`Ready` SubApp.  

.. seealso:: :py:mod:`~nistoar.pdr.publish.service.wsgi.pdp`
"""
...
from nistoar.web.rest import ServiceApp, WSGIAppSuite, Unauthenticated, Handler
...
class Ready(ServiceApp):
    ...
    class _Handler(Handler):
        ...
        def __init__(self, path: str, wsgienv: dict, start_resp: Callable, who=None,
                     config: dict={}, log: logging.Logger=None):
